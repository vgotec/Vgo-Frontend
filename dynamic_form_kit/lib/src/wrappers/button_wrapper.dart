  ...
  class ButtonWrapper extends StatelessWidget {
    ...
    Widget build(BuildContext context) {
      ...
      // Parse styles
      final Color backgroundColor = StyleParser.parseColor(style['backgroundColor'], Colors.blue);
      final Color textColor = StyleParser.parseColor(style['textColor'], Colors.white);
    ...
    if (action != null) {
      ...
      final Map<String, dynamic> payload = action['payload'] as Map<String, dynamic>? ?? {};
      debugPrint("ButtonWrapper: Dispatching actionType='$actionType', payload='$payload'");
